...
const Header = () => {
  ...
  return (
   <article className={`navbar__container ${scroll > 20 ? 'scroll__navbar' : ''}`}>
    <Cart/>
     ...
     <header className="navbar">
      ...
      <i className='bx bx-menu'></i>
        ...
        <article className="navbar__width">
          ...
          <li className="nav__li">
            <Link className='nav__link' to={"/purchased"}>Purchases</Link>
            <i className='bx bx-shopping-bag'></i>
          </li>
          <li className="nav__li active">
            <button onClick={handleCart} className="navbar__btn" >Cart</button>
           <i className='bx bx-store-alt'></i> 
          </li>
          <li className="nav__li active">
            <button onClick={handleSearch} className="navbar__btn">Search</button>
